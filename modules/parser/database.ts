...
import { Company, Month } from '@/types/parser';
...
export const compareTwoMonths = async (month1: string, month2: string) => {
...
export const compareFromToSubsequentMonthPairs = async (start: string, end: string) => {
  const months = db
